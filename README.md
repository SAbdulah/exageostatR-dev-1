...
`ExaGeoStat-R` is an R-Wrapper or [ExaGeoStat framework](https://github.com/ecrc/exageostat): a parallel high performance unified framework for geostatistics on manycore systems
